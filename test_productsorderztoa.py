...
import openpyxl
class TestTestproductsorderztoa():
  ...
  def test_testproductsorderztoa(self):
    ...
    self.driver.find_element(By.XPATH,Z_TO_A_OPTION).click()
    ...
    for i in range(len(products)):
      if products[i].text.strip() != productsFromExcel[i].value.strip():
